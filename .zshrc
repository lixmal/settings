...
export PATH="$HOME/dev/go/bin:$HOME/bin:$PATH"

export HISTFILE="$HOME/.history"
export HISTSIZE=10000000

# Path to your oh-my-zsh installation.
export ZSH="/home/vliu/.oh-my-zsh"
